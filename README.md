...
- дубликаты (включая повторы между чатами): не чаще 1 раза в 12ч, текстовые дубли считаются от 12 символов, одинаковые пересланные тоже учитываются; эскалация `объяснение -> предупреждение -> кик`
